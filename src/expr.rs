...
fn is_pure_function_name(name: &str) -> bool {
    language::is_pure_function(name)
}

fn is_builtin_function(name: &str) -> bool {
    language::is_builtin_function(name)
}
...
fn is_array_name_function(name: &str) -> bool {
    language::is_array_name_function(name)
}

pub(crate) fn is_zero_arg_function(name: &str) -> bool {
    language::is_zero_arg_function(name)
}

pub(crate) fn is_pi_constant_name(name: &str) -> bool {
    language::is_pi_constant_name(name)
}
