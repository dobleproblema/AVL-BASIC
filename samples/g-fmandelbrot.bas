...
150 DEG
155 ON MOUSE LEFTDOWN GOSUB 400
160 CLICKED=0 : CLG : SCALE XMI,XMA,YMI,YMA : t1=TIME
...
320 IF CLICKED=0 THEN PAUSE 10
325 IF CLICKED=0 THEN 320
330 REM Zoomed view centered on the pointer coordinates
340 cx=CLICKX : cy=CLICKY
...
380 GOTO 160
400 CLICKX=MOUSEX : CLICKY=MOUSEY : CLICKED=1 : RETURN
