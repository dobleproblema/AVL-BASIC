...
50 CLS
60 Spd=12
70 notes$=" a-b b c+c d-e e f+f g+g"
...
290 n1$=" "+n1$
300 nd1=(1+INSTR(notes$,LOWER$(n1$)))/2
310 IF ASC(RIGHT$(n1$,1))>96 THEN o1=8 ELSE o1=16
320 SOUND 1+r1,notes(nd1)/o1,Spd*l1,0,1,1
...
470 n2$=" "+n2$
480 nd2=(1+INSTR(notes$,LOWER$(n2$)))/2
490 IF ASC(RIGHT$(n2$,1))>96 THEN o2=4 ELSE o2=8
500 SOUND 2+r2,notes(nd2)/o2,Spd*l2,0,2
