...
150   PAPER m : INK 0 : LOCATE x,i : GPRINT SPACE$(53); : m=3-m
160   'Print 7 lines of stars alternating between 6 and 5
170   IF i<y+7 THEN PAPER 4:INK 1:LOCATE x,i:GPRINT MID$(s$,m+m-1,23);
180 NEXT i
190 PAPER 0 : INK 1 : BIGFONT : LOCATE 15,25 : GPRINT "OLD GLORY"
200 END
