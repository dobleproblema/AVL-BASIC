...
Set AVL_BASIC_PY_REPO or pass --python-repo to point at the external Python
reference checkout.
...
SESSION_NOISE_RE = re.compile(
    ...
    r"This is free software under the MIT License\. You may redistribute it under its terms\.|"
    r"This program comes with ABSOLUTELY NO WARRANTY\. See COPYING\.|"
    r"Type HELP <topic> for syntax and parameters\.|"
...
def python_repo_from_args(value: str | None) -> Path:
    ...
    raise SystemExit("Set AVL_BASIC_PY_REPO or pass --python-repo to use the Python oracle")
